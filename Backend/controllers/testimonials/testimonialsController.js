...
import { getTestimonial, createTestimonial, updateTestimonial, deleteTestimonial, getTestimonials } from '../../database/queries/testimonials/testimonialquery.js';
...
export const createOneTestimonial = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const newTestimonial = await createTestimonial({ email, content, rating });
